...
│   ├── 01-apertura.md                # Block 1: Opening (10 min)
│   ├── 02-fundamentos.md             # Block 2: MCP concepts, architecture (25 min)
│   ├── 03-anatomia-proveedor.md      # Block 3: Server structure, live coding (20 min)
│   ├── 04-ejercicio-1-recursos-estaticos.md # Block 4: Exercise 1 (15 min)
│   ├── 05-ejercicio-2-consultas-parametricas.md # Block 5: Exercise 2 (20 min)
│   ├── 06-ejercicio-3-seguridad.md   # Block 6: Exercise 3 instructions (20 min)
│   ├── 07-seguridad-gobernanza.md    # Block 7: Security micro-charla (15 min)
